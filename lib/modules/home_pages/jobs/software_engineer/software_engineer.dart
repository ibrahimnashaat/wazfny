...
class SoftwareEngineer extends StatefulWidget {
  const SoftwareEngineer({Key? key}) : super(key: key);

  @override
  State<SoftwareEngineer> createState() => _SoftwareEngineerState();
}

class _SoftwareEngineerState extends State<SoftwareEngineer> {
              ...
              Expanded(
                ...
                child:StreamBuilder<QuerySnapshot>(
                  ...
                  builder:(context,snapshots){
                    return (snapshots.connectionState == ConnectionState.waiting)?const Center(child: CircularProgressIndicator(),):ListView.separated(
